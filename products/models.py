...
class ProductModel(models.Model):
    ...
    product_long_description = models.TextField(verbose_name=_('product_long_description'),max_length=86, null=True)
    ...
    category = models.ForeignKey(CategoryModel, on_delete=models.PROTECT, related_name='products', null=True,
                                 verbose_name=_('category'), )
    width = models.ForeignKey(WidthModel, on_delete=models.PROTECT, null=True, blank=True, related_name='products',
                              verbose_name=_('width'))
    height = models.ForeignKey(HeightModel, on_delete=models.PROTECT, null=True, blank=True, related_name='products',
                               verbose_name=_('height'))
    weight = models.ForeignKey(WeightModel, on_delete=models.PROTECT, null=True, blank=True, related_name='products',
                               verbose_name=_('weight'))
    tags = models.ManyToManyField(ProductTagModel, related_name='products', blank=True, verbose_name=_('tags'))
