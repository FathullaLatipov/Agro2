...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0053_auto_20210927_1722'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='productmodel',
            name='image55',
            field=models.FileField(blank=True, null=True, upload_to='products', verbose_name='image55'),
        ),
        migrations.AlterField(
            model_name='productmodel',
            name='image66',
            field=models.FileField(blank=True, null=True, upload_to='products', verbose_name='image66'),
        ),
        migrations.AlterField(
            model_name='productmodel',
            name='image77',
