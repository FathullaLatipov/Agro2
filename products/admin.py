...
from products.models import ProductTagModel, ProductModel, CommentModel, \
...
class ProductModelAdmin(MyTranslationAdmin):
    list_display = ['id', 'title', 'price', 'sku', 'category', 'title', 'created_at']
    search_fields = ['category', 'tags', 'created_at']
    list_filter = ['title', 'created_at']
    autocomplete_fields = ['category', 'tags', 'width', 'height', 'weight']
